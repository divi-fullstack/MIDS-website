  ...
  <Layout>
    ...
    <div className="home-wrapper">
      <div className="banner-section" style={{ background: "rgb(84 136 85)" }}>
        <div className="pl-5 pr-5 container-fluid">
          ...
          <div className="section-2">
            ...
            <div class="section2_content_wrapper">
              <p style={{ textAlign: "center" }}>
                ...
                solutions in mobile, web and enterprise domain. MIDS is a group
                of top-notch individuals committed to go the extra miles to
      ...
      <div
        className="pl-5 pr-5 pt-5 pb-5 container-fluid"
        style={{ backgroundColor: "#f0f7fe" }}
      >
        <div className="expended-container section3 row">
          <PortfolioListItem/>
          <PortfolioListItem/>
           <PortfolioListItem/>
           <PortfolioListItem/>
